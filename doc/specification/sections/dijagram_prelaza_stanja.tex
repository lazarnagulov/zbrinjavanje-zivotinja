...
\par Svaka objava može da se nalazi u 6 različitih stanja: \textit{na čekanju}, \textit{odbijena},
...
\end{enumerate}
\par Dijagram prelaza stanja sa slike \ref{fig:state} se može prevesti u \textbf{klasni dijagram} koji se nalazi
